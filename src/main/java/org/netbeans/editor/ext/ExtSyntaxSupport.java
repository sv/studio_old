    ...
    */
    ...
    final class TokenItemTP implements TokenProcessor {
        ...
        TokenItemTP() {
            ...
            // Start listening on document changes
            docL = new DocumentListener() {
                       public void insertUpdate(DocumentEvent evt) {
                           if (lastItem != null && evt.getOffset() < lastItem.getOffset()
                                   + lastItem.getImage().length()
                              ) {
                               docModified = true;
        ...
        protected void finalize() throws Throwable {
            if (docL != null) {
                getDocument().removeDocumentListener(docL);
                docL = null;
            }
    ...
    class FirstTokenTP implements TokenProcessor {
